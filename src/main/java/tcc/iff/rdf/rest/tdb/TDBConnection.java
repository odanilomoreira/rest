...
public class TDBConnection {
	...
	public void addStatement(String modelName, String subject, String property, String object) {
		...
		try {
			...
			Statement stmt = model.createStatement(model.createResource(subject), 
	...
	public void removeStatements(String modelName, String subject, String property, String object) {
		Model model = null;
